...
Instalación con **npx** que no requiere dependencias de [`prism`](https://github.com/mcp-tool-shop-org/prism-verify), una herramienta de línea de comandos (CLI) que actúa como verificador de LLM en tiempo de ejecución (diferente según la familia, sin razonamiento, con múltiples perspectivas y con recibos firmados con Ed25519).
